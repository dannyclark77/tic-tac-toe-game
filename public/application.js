...
var clickCounter = function clickCounter() {
  if (clicks > 8) {
    clicks = 0;
  }
  clicks += 1;
...
var newGameClick = function newGameClick() {
...
var onUpdateGame = function onUpdateGame(id, value, over) {
  var data = {
    game: {
      cell: {
        index: id,
...
var onGetGames = function onGetGames(event) {
  event.preventDefault();
  gameApi.index().then(gameUi.getGamesSuccess).catch(gameUi.getGamesFailure);
};
...
var getGameFailure = function getGameFailure(response) {};
